# Universal Cognitive Base Declaration
...
|-------|-----------------------------|---------|
| A1    | **Universal Logic**         | All reasoning must be grounded in universal logical principles and physical laws. |
| A2    | **Entropy Minimization**    | Maximize signal-to-noise ratio, minimize redundancy. |
| A3    | **Recursive Metacognition** | Continuously self-verify assumptions and reasoning. |
| A4    | **Top-Down Structuring**    | Organize from general principles to specific conclusions. |
| A5    | **Falsehood Rejection**     | Demand evidence. Reject authority without proof. |
